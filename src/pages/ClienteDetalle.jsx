...
function ClienteDetalle() {
  ...
  const [form, setForm] = useState({ nombre: '', especie: '', especiePersonalizada: '', raza: '', edad: '', peso: '', sexo: '' })
  ...
  const handleGuardar = async () => {
    ...
    setForm({ nombre: '', especie: '', especiePersonalizada: '', raza: '', edad: '', peso: '', sexo: '' })
    setEditando(null)
    setShowModal(false)
    cargarMascotas()
  }
  ...
  const handleEditar = (mascota) => {
    setForm({ nombre: mascota.nombre, especie: mascota.especie, especiePersonalizada: '', raza: mascota.raza, edad: mascota.edad, peso: mascota.peso, sexo: mascota.sexo })
      ...
      <div className="p-6 max-w-3xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <button onClick={() => { setShowModal(true); setEditando(null); setForm({ nombre: '', especie: '', especiePersonalizada: '', raza: '', edad: '', peso: '', sexo: '' }) }}
